...
extension CourtQueryWhere on QueryBuilder<Court, Court, QWhereClause> {
  QueryBuilder<Court, Court, QAfterWhereClause> idEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Court, Court, QAfterWhereClause> idNotEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Court, Court, QAfterWhereClause> idGreaterThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Court, Court, QAfterWhereClause> idLessThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<Court, Court, QAfterWhereClause> idBetween(
    Id lowerId,
    Id upperId, {
...
extension CourtQueryFilter on QueryBuilder<Court, Court, QFilterCondition> {
  QueryBuilder<Court, Court, QAfterFilterCondition> idEqualTo(Id value) {
    return QueryBuilder.apply(this, (query) {
...
extension CourtQueryProperty on QueryBuilder<Court, Court, QQueryProperty> {
  QueryBuilder<Court, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
